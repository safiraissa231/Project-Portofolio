...
prompts = {
    "Mistral": "Summarize this discussion in a single formal paragraph, consisting of indirect sentences, in Bahasa Indonesia, with a maximum limit of 300 words",
    "Llama": "Summarize this discussion in a single formal paragraph, consisting of indirect sentences, in Bahasa Indonesia, with a maximum limit of 300 words",
    "Qwen": "Summarize this discussion in a single formal paragraph, consisting of indirect sentences, in Bahasa Indonesia, with a maximum limit of 300 words"
}
