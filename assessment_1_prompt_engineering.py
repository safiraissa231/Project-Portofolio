...
prompts = {
    "Mistral": "Summarize in one formal paragraph in Bahasa Indonesia.",
    "Llama": "Summarize in one formal paragraph in Bahasa Indonesia.",
    "Qwen": "Summarize in one formal paragraph in Bahasa Indonesia."
}
