...
prompts = {
    "Mistral": "Summarize this discussion in one formal paragraph, consisted with indirect sentences, using Bahasa Indonesia.",
    "Llama": "Summarize this discussion in one formal paragraph, consisted with indirect sentences, using Bahasa Indonesia.",
    "Qwen": "Summarize this discussion in one formal paragraph, consisted with indirect sentences, using Bahasa Indonesia."
}
